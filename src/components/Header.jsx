    ...
    <header className="container mx-auto bg-[rgb(25,33,22)] sticky top-0 z-50">
      <nav className="max-w-7xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        <ul className="hidden md:flex items-center gap-8 text-white font-medium">
          <li>
            <Link to="/" onClick={() => window.scrollTo({top:0,behavior:"smooth"})} className="transition-colors duration-300">
              Bosh Sahifa
            </Link>
          </li>
          <li>
            <Link to="/about" onClick={() => window.scrollTo({top:0,behavior:"smooth"})} className="transition-colors duration-300">
              Biz haqimizda
            </Link>
          </li>
          <li>
            <Link to="/products" onClick={() => window.scrollTo({top:0,behavior:"smooth"})} className=" transition-colors duration-300">
              Mahsulotlar
            </Link>
          </li>
        </ul>
        ...
        <select
          name="lang"
          id="lang"
          className="border bg-[rgb(25,33,22)] appearance-none text-white border-white/20 rounded-md px-3 py-1 cursor-pointer focus:outline-none"
        >
          <option value="uz" className="bg-[rgb(25,33,22)] text-white">
            UZ
          </option>
          <option value="ru" className="bg-[rgb(25,33,22)] text-white">
            RU
          </option>
        </select>
      </nav>
