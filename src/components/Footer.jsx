...
const Footer = () => {
  return (
    <footer className="bg-[rgb(34,44,29)] container mx-auto text-gray-300 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam, ratione possimus. Nam quasi quam quidem.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm flex items-center gap-1"><IoLocationOutline /> Toshkent, O‘zbekiston</p>
          <p className="text-sm flex items-center gap-1"><FaPhoneAlt /> +998 90 123 45 67</p>
          <p className="text-sm flex items-center gap-1"><CiMail /> info@entermchj.uz</p>
        </div>

        <div>
          <h4 className="text-white font-semibold mb-4">Bizni kuzating</h4>
          <div className="flex gap-4">
            <a href="https://facebook.com" className="text-blue-400 transition">
              <FaFacebook size={20} />
            </a>
            <a href="https://instagram.com" className="text-red-500 transition">
              <FaInstagram size={20} />
            </a>
            <a href="https://t.me" className="text-blue-500 transition">
              <FaTelegram size={20} />
            </a>
          </div>
        </div>
